...
public class EditprofileAcr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editprofile_acr);
        getUsernamelocal();
        ...
        storage = FirebaseStorage.getInstance().getReference().child("Photousers").child(username_key_new);
            //addValueEventListener untuk mendapatkan updatan terbaru secara realtime
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.with(EditprofileAcr.this)
            ...
            btn_save.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //validasi untuk file apakah sudah ada?
                    //jika potonya sudah ada maka di simpan
                    if (photo_location != null){
                        final StorageReference storageReference1 =
                                storage.child(System.currentTimeMillis()+"."+
                                        getFileExtention(photo_location));
                        //ketika berhasil di ambil fotonya lalu di letakan pada database
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                            ...
                                            public void onComplete(@NonNull Task<Uri> task) {
                                                //berpindah activity
                                                Intent backkeprofile = new Intent(EditprofileAcr.this, MyprofileAct.class);
                                                startActivity(backkeprofile);
                                            }
                                        });
                                        //setelah gambarnya komplit, akan pidah acivity
                                    }
                    ...
                    Intent gogetnetxregister = new Intent(EditprofileAcr.this, HomeAct.class);
                    startActivity(gogetnetxregister);
                }
            });
    ...
    //getFileExtention menyimpan foto di firebase
