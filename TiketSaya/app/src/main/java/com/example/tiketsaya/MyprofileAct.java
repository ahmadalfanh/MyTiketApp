...
public class MyprofileAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Item_ticket01 = findViewById(R.id.Item_ticket01);
        ...
        btn_edit_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent  gotoEditProfile = new Intent(MyprofileAct.this,  EditprofileAcr.class);
        ...
        btn_back_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent  Kehome = new Intent(MyprofileAct.this,  HomeAct.class);
        ...
        btn_sign_out.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //menghapus value dari username lokal
                ...
                //berpindah activity
                Intent  Kehome = new Intent(MyprofileAct.this,  SigninAct.class);
                startActivity(Kehome);
                finish();
