...
public class RegisterOneAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ketika button continue di tekan makan data akan tersimpan di firebase
                ...
                if (username.isEmpty()) {
                    ...
                    if (password.isEmpty()) {
                        ...
                        if (email_address.isEmpty()){
                            ...
                            //berindah aktifity
                            Intent gogetnetxregister = new Intent(RegisterOneAct.this, RegisterTwoAct.class);
